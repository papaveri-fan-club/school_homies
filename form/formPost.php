...
<body>
    ...
    <script>
        ...
        `;
                ...
                // Aggiungi campi per Tipo 3
                extraFields.innerHTML = `
            <div class="form-group">
                <label for="extra_field_3">Campo Extra per Tipo 3</label>
                <input type="number" class="form-control" id="extra_field_3" name="extra_field_3" placeholder="Campo numerico per Tipo 3">
            </div>
        `;
            } else if (typePost == "4") {
